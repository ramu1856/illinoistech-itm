...
object MnMcount {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val mnmDF = spark.read.format("csv")
      ...
      .load(s"file:///$mnmFile")  // Use file:// scheme for local file paths in Spark
...
MnMcount.main(Array("/mnt/c/Users/USER/Documents/itmd-521/LearningSparkV2/chapter2/scala/data/mnm_dataset.csv"))
